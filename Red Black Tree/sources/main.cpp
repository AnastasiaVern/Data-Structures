...
int main(int argc, char* argv[])
{
    ...
    if (argc != 2)
        ...
        if (!fin.is_open())
            ...
            if (counter1)
                fout_ << "duration of insertion: " << elapsed1.count() * counter1 << "ns.\n";
            if (counter2)
                fout_ << "duration of deletion: " << elapsed2.count() * counter2 << "ns. \n";
            if (counter3)
                fout_ << "duration of searching: " << elapsed3.count() * counter3 << "ns. \n";
        }
    }
    system("pause");
    return 0;
